<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomerCatalog1.ascx.cs" Inherits="RamlyRestaurant.WebUserControl.CustomerCatalog1" %>
<div align="center">
            ...
            <td runat="server" style="column-width: 410px" align="center">
                <p>
                    <asp:HyperLink ID="HyperLink2" Text='<%# Eval("prod_name") %>'
                        runat="server" NavigateUrl='<%# "~/CustomerProduct.aspx?prod_id=" + Eval("prod_id") %>'></asp:HyperLink>
                </p>
