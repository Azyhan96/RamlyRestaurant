<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ViewUser.ascx.cs" Inherits="RamlyRestaurant.WebUserControl.ViewUser" %>
<div align="center">
...
<br />
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cust_id" DataSourceID="SqlDataSource1" PageSize="6">
    <Columns>
